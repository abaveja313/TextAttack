...
class StringQuoteSingleTransformer(PostprocessingTransformer, category=CRT.lexical):
    @property
...
class StringQuoteDoubleTransformer(PostprocessingTransformer, category=CRT.lexical):
    @property
    def deterministic(self):
        return True
