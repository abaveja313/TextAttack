...
from textattack.shared.utils import one_by_one
...
class IdentifierRenameTransformer(OneByOneTransformer, categories=CRT.lexical):
    @property
    def visitor(self) -> Type[OneByOneVisitor]:
        return IdentifierRenameVisitor


class IdentifierObfuscateTransformer(OneByOneTransformer, categories=CRT.lexical):
    @property
    def visitor(self) -> Type[OneByOneVisitor]:
