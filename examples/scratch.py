...
example = data["HumanEval/147"]["prompt"] + data["HumanEval/112"]["canonical_solution"]
...
ground_truth_output = "HumanEval/111"
...
initializer = TestPassingInitializer(
    model=wrapper, task_id=ground_truth_output, num_samples=200, batch_size=100
)
